...
<div class="container">
     <nav aria-label="breadcrumb" style="background-color: #fff;" class="mt-3">
        <ol class="breadcrumb p-3">
            ...
            <li class="breadcrumb-item"><a href="../../kategori/elektronik.html" class="text-decoration-none">Kategori</a></li>
...
<div class="container">
    <div class="row row-produk">
        <div class="col-lg-5">
            <figure class="figure">
                <img src="../../assets/produk/elektronik/tv-1.jpg" class="figure-img img-fluid" style="border-radius: 5px; width: 450px;">
             <figcaption class="figure-caption d-flex justify-content-evenly">
                 <a href="#">
                     <img src="../../assets/produk/elektronik/tv-1.jpg" class="figure-img img-fluid" style="border-radius: 5px; width: 70px;">
                 </a>
                 <a href="#">
                    <img src="../../assets/produk/elektronik/tv-1.jpg" class="figure-img img-fluid" style="border-radius: 5px; width: 70px;">
                </a>
        ...
        <div class="col-lg-5">
            <h4>Televisi LED 24 inch Panasonic</h4>
            <div class="garis-nama"></div>
            <h3 class="text-muted mb-3">Rp 1.500.000</h3>
            ...
            <span class="mx-4">Tersisa 7</span>
