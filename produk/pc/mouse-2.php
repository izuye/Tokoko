...
<div class="container">
    <div class="row row-produk">
        <div class="col-lg-5">
            <figure class="figure">
                <img src="../../assets/produk/pc/mouse-2.jpg" class="figure-img img-fluid" style="border-radius: 5px; width: 450px;">
             <figcaption class="figure-caption d-flex justify-content-evenly">
                 <a href="#">
                     <img src="../../assets/produk/pc/mouse-2.jpg" class="figure-img img-fluid" style="border-radius: 5px; width: 70px;">
                 </a>
                 <a href="#">
                    <img src="../../assets/produk/pc/mouse-2.jpg" class="figure-img img-fluid" style="border-radius: 5px; width: 70px;">
                </a>
        ...
        <div class="col-lg-5">
            <h4>Joyseus MS-0007 USB Wired</h4>
            <div class="garis-nama"></div>
            <h3 class="text-muted mb-3">Rp 85.000</h3>
            ...
            <span class="mx-4">Tersisa 30</span>
