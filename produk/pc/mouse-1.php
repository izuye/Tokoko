...
<div class="container">
    <div class="row row-produk">
        <div class="col-lg-5">
            <figure class="figure">
                <img src="../../assets/produk/pc/mouse-1.jpg" class="figure-img img-fluid" style="border-radius: 5px; width: 450px;">
             <figcaption class="figure-caption d-flex justify-content-evenly">
                 <a href="#">
                     <img src="../../assets/produk/pc/mouse-1.jpg" class="figure-img img-fluid" style="border-radius: 5px; width: 70px;">
                 </a>
                 <a href="#">
                    <img src="../../assets/produk/pc/mouse-1.jpg" class="figure-img img-fluid" style="border-radius: 5px; width: 70px;">
                </a>
        ...
        <div class="col-lg-5">
            <h4>Joyseus MS-0002 Wireless</h4>
