...
<div class="container">
     <nav aria-label="breadcrumb" style="background-color: #fff;" class="mt-3">
        <ol class="breadcrumb p-3">
            ...
            <li class="breadcrumb-item"><a href="../../kategori/jamtangan.html" class="text-decoration-none">Kategori</a></li>
...
<div class="container">
    <div class="row row-produk">
        <div class="col-lg-5">
            <figure class="figure">
                <img src="https://s0.bukalapak.com/img/59830009152/large/data.jpeg" class="figure-img img-fluid" style="border-radius: 5px; width: 450px;">
             <figcaption class="figure-caption d-flex justify-content-evenly">
                 <a href="#">
                     <img src="https://s0.bukalapak.com/img/59830009152/large/data.jpeg" class="figure-img img-fluid" style="border-radius: 5px; width: 70px;">
                 </a>
                 <a href="#">
                    <img src="https://s0.bukalapak.com/img/59830009152/large/data.jpeg" class="figure-img img-fluid" style="border-radius: 5px; width: 70px;">
                </a>
        ...
        <div class="col-lg-5">
            ...
            <h3 class="text-muted mb-3">Rp 145.000</h3>
